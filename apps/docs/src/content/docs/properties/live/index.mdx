...
| `scroll-m*`     | Set spacing around element (margin) for snapping or scrolling.           | [scroll margin](/docs/properties/live/scroll-margin)   |
| `scroll-p*`     | Set spacing inside element (padding) for snapping or scrolling.          | [scroll padding](/docs/properties/live/scroll-padding) |
