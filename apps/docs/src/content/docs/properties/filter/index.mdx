...
| `bright-*`   | Adjust brightness filter effects.                      | [brightness](/docs/properties/filter/bright)   |
| `contrast-*` | Control contrast filter effect.                        | [contrast](/docs/properties/filter/contrast)   |
| `gray-*`     | Apply grayscale filter to elements.                    | [grayscale](/docs/properties/filter/gray)      |
...
| `saturate-*` | Adjust saturation filter on element colors.            | [saturation](/docs/properties/filter/saturate) |
...
| `backdrop-saturate-*` | Adjust backdrop saturation filter values.           | [backdrop saturation](/docs/properties/filter/backdrop/saturate) |
