...
As per development and primary testing, the current setup works reliably for
**SPA frameworks** like React and Vue.

At this point in time, Shilp CSS has a known limitation related to **Purge CSS
integration** when used with **MPA frameworks** or frameworks that perform
additional processing after the bundler stage (for example Next and Nuxt).
...
Currently Shilp CSS is in **alpha** version and the focus is on React, Vue and
Next. <br /> Future considerations are Nuxt, Tanstack Start, and Svelte.
...
This is intended for vite based frameworks and / or ideal for **SPA** frameworks
like React and Vue.
...
Add following files to your main style file which is being imported in your
frameworks entry point.
...
Now you can officially [Begin Your Journey](/docs#begin-your-journey) with Shilp
CSS.
...
`source: null` will disable the CSS purging. This is recommended option for
current release.
