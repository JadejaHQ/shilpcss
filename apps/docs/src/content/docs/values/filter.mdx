...
The **Filter dataset** defines values used for CSS **filter functions** for
visual effects.
...
The dataset is a **nested key–value map** of filter related tokens to CSS
values.
...
This will make additional filter related tokens available through the theme
system.
