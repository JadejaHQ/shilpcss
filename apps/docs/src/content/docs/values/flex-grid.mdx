...
The **Flex & grid dataset** defines values used for **grid layout structure**
and **item placement**.
...
The dataset is a **nested key–value map** of flex & grid related tokens to CSS
values.
...
This will make additional flex & grid related tokens available through the theme
system.
