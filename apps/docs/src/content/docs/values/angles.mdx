...
The **Angles dataset** defines angle units used by CSS properties that require
**degree values (`deg`)**.
...
Resolved location: `shilpConfig.values.angles` <br /> Theme location:
`shilpConfig.theme.angles`
