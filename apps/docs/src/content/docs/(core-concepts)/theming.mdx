...
Theming in Shilp CSS is **not just about colors**. It is about defining **design
tokens**, that shape how your system _looks and feels_.

Design tokens are not decoration. They are **system primitives**. They define
